...
fn test_key_derivation() {
    ...
    let send_key =
        DatumProtocolClient::derive_key_from_shared_secret_static(shared_secret, b"send");
    let recv_key =
        DatumProtocolClient::derive_key_from_shared_secret_static(shared_secret, b"recv");
    ...
    let other_key =
        DatumProtocolClient::derive_key_from_shared_secret_static(shared_secret, b"other");
